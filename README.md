...
1. Проверка действий на странице с подписками.
2. Проверка модели пользователей по CRUD(create read update delete). Проверка создания пользователей и создания сессий. а также реализации восстановления пароля. Далее идет просмотр пользователей. Дальше проверка на редактирование пользователей. И наконец провека удаления.
3. Проверка модели постов также по CRUD. Проверки будут проходить для анонимных пользователей и для зарегистрированных. Также осуществим проверку взаимодействия между пользователями, те проверка безопасности деятельности пользователей.
4. Проверка верстки сайта.
...
Предисловие: Открыта страница поиска постов. Была пройдена аунтентификация.
...
Предисловие: Открыта страница поиска постов. Не Была пройдена аунтентификация.
...
3. Нажать кнопку "Sign up" - ожидается: Произошла аунтентификация. Открытие страницы просмотра постов. Вывод ссылок "Profile" и "Log out", а также удаление "Sign in" и "Sign up". Вывод надписи об успешном созданом пользователе "Welcome! You have signed up successfully." :heavy_check_mark:
...
3. Нажать кнопку "Log in" - ожидается: Произошла аунтентификация. Открытие страницы просмотра постов. Вывод ссылок "Profile" и "Log out", а также удаление "Sign in" и "Sign up". Вывод надписи об успешной аунтентификация "Signed in successfully." :heavy_check_mark:
...
Предисловие: Открыта страница "Sign in" . Не была пройдена аунтентификация.
...
6. Нажать на кнопку "Change my password" - ожидается: Произошла аунтентификация. Открытие страницы просмотра постов. Вывод ссылок "Profile" и "Log out", а также удаление "Sign in" и "Sign up". Вывод надписи об успешной аунтентификация "Your password has been changed successfully. You are now signed in." :heavy_check_mark:
...
10. Нажать кнопку "Log in" - ожидается: Произошла аунтентификация. Открытие страницы просмотра постов. Вывод ссылок "Profile" и "Log out", а также удаление "Sign in" и "Sign up". Вывод надписи об успешной аунтентификация "Signed in successfully." :heavy_check_mark:
...
Предисловие: Открыта страница поиска постов. Была пройдена аунтентификация. Был создан хотя бы 1 пост от этого аккаунта
...
8. Нажать кнопку "Log in" - ожидается: Произошла аунтентификация. Открытие страницы просмотра постов. Вывод ссылок "Profile" и "Log out", а также удаление "Sign in" и "Sign up". Вывод надписи об успешной аунтентификация "Signed in successfully." :heavy_check_mark:
...
Предисловие: Открыта страница поиска постов. Была пройдена аунтентификация. Посты отсутствуют у пользователя
...
Предисловие: Открыта страница поиска постов. Была пройдена аунтентификация. Создан пост.
...
Предисловие: Открыта страница поиска постов. Была пройдена аунтентификация. Присутствует пост.
...
1. Предисловие: Открыта страница поиска постов. Была пройдена аунтентификация. Присутствует пост.
...
1. Предисловие: Открыта страница поиска постов. Была пройдена аунтентификация.
...
1. Предисловие: Была пройдена аунтентификация. Открыта страница создания поста. 
...
1. Предисловие: Была пройдена аунтентификация. Открыта страница "Edit user". Пост создан.
...
1. Предисловие: Была пройдена аунтентификация. Пост создан. Открыта страница "Edit post".
...
Шаги
1. Предисловие: Была пройдена аунтентификация. Пост создан. Открыта страница главная страница.
